...
import { allNaturales }  from '../lib/postgraphile'
import { deletePersonaNatural }  from '../lib/postgraphile'
...
const App = () => {
  ...
  useEffect(() => {
    ...
    const data = await allNaturales();
    console.log(data)
    const mapData = data.map((item, index) => ({
      key: index,
      nombre: item.nombre,
      apellido: item.apellido,
      tipoDocumento: item.tipoDocumentoByIdTipoDocumento.tipoDocumento,
